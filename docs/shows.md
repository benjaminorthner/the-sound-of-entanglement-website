...
Verified against drive documents, performance logs, event pages and the paper.
Detailed evidence is in `research/drive_documents.md` §1 and
`research/web_presence.md` §3.

Legend: **Performance** = live with the experiment. **Talk** = presentation
only. **Exhibition** = video or display.

## Upcoming

| Date | Where | What | Status |
|---|---|---|---|
| **16 Oct 2026** | University of Innsbruck, Austria | Dies Academicus / MIP Alumni Day | Booked. Details (piece, line-up, time, venue) to be announced. |
| Nov 2026 | Wien Modern festival, Vienna | ? | Tentative ("looking good" in Dec 2025 notes). Do not publish yet. |
| Oct/Nov 2026, Feb/Mar 2027 | ? | Album release concerts | Planned in the album spreadsheet, unconfirmed |
...
The team's own "past performances" list (Pint of Science deck, 2026) has 8
entries: Linz, the Ball, Osaka, Washington, Millstatt, Alpbach, CIVA and
Zirkus des Wissens. Use it as the canonical public list; talks can go on a
separate "talks" list.

## Resolved discrepancies

- **BruQner dates: 4 & 6 Sept 2024**, not 4 & 5. The bruQner repo's
  `docs/performance_history.md` is wrong about this.
- **8 Rooms premiere: 25 Jan 2025.** Sets ran past midnight, hence "26 Jan" in
  some notes.
- **CIVA: 3 Oct 2025**; 2 Oct was setup.
- **Zirkus des Wissens: 19 Nov 2025**; a quantA page says 21 Nov, which is wrong.
- **Audience:** say "over 3 000" (some sources say 3 100 or 3 200).
- **Osaka** was a video exhibition, not a concert. The "Osaka" photo folder is
  actually 2024 pre-premiere sessions.

## Cancelled / did not happen (never list)

Paris/UNESCO (Feb 2025, planning only), JKU Summer Ball (13 Jun 2025,
cancelled because of national mourning), Innsbruck Schülerlabor opening
(5 Sept 2025, cancelled).

## Pre-history (for a "process" or BruQner page)

Nov 2022 Brucknerjahr application · 10 May 2023 lab session in Innsbruck ·
June/July 2023 press photos and portraits · Nov 2023 site visit at the
Mariendom · 21 May and 13 Jun 2024 test sessions (haze, band) · 4–5 Jul 2024
visual test in the Dom · 2–3 Sept 2024 rehearsals.
