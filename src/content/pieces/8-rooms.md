...
title: 8 Rooms
year: 2025
forces: for synthesizer, electric bass, drums, two clicking wave plates and entangled photons
composers: [Clemens Wenger, Manu Mayr, Judith Schwarz]
status: repertoire
order: 2
summary: The motors that choose each measurement click, and the clicks become the metronome. A quantum random walk leads the band through eight rooms, each with its own sound.
mapping: Each measurement moves a walker one step through a room; when it reaches a wall, the band walks through a door into the next room.
visualsBy: [Benjamin Orthner, Enar de Dios Rodríguez]
visual: terrain
cover:
  src: ../../assets/photos/2025-washington/landscape-above-stage.jpg
  alt: A white-line landscape fills the screen above the band and the lit experiment on stage.
  credit: Kaveh Sardari
images:
  - src: ../../assets/photos/2025-alpbach/lines-on-ceiling.jpg
    alt: White lines projected across the ceiling above the trio and the experiment, in purple stage light.
...
The visuals start with two fine white lines on black, one for Alice and one
for Bob: the sound spectra of the two clicks. As measurements accumulate, they
pile up into a histogram that grows into an undulating landscape of white
lines. Each room has its own camera angle and line treatment.
